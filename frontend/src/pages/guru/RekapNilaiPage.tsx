...
export function RekapNilaiPage() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      toast.show('error', 'Gagal memuat rekap nilai akhir.');
    } finally {
      setLoading(false);
    }
  }, [penugasanId]);
    ...
    <div className="mt-4">
      ...
      {rows.length > 0 && (
        <div className="mb-3 flex gap-3 flex-wrap">
          <div className="rounded-lg bg-blue-50 border border-blue-100 px-4 py-2 text-sm">
            <span className="text-aam-muted">Rata-rata:</span>
          ...
          <div className="rounded-lg bg-gray-50 border border-gray-200 px-4 py-2 text-sm">
            <span className="text-aam-muted">Sudah ada nilai:</span>
      ...
      {loading ? <TableSkeleton rows={5} /> : rows.length === 0 ? (
        ...
        <Card>
            ...
            <table className="w-full text-sm">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="px-3 py-2.5 text-center text-aam-muted font-semibold border-b border-aam-border">Nilai Akhir</th>
                </tr>
              </thead>
                  ...
                  <tr key={r.siswaId} className="hover:bg-gray-50">
                    ...
                    <td className="px-3 py-2 text-center">
                      {r.nilaiAkhir !== null
                        ...
                        : <span className="text-aam-muted text-xs">Belum ada nilai Sumatif</span>
                      }
                    </td>
                  </tr>
                ))}
          ...
          <p className="text-xs text-aam-muted mt-2 px-3 pb-1">
