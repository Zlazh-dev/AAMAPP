...
export function RaporListPage() {
 ...
 <th className="px-3 py-2.5 text-center text-aam-text-muted font-semibold border-b border-aam-border">Status</th>
 <th className="px-3 py-2.5 text-center text-aam-text-muted font-semibold border-b border-aam-border">Aksi</th>
 </tr>
 </thead>
