...
function IzinForm({ onSuccess }: { onSuccess: () => void }) {
 ...
 <p className="text-xs text-aam-text-muted -mt-2">
 ...
 URL Lampiran <span className="text-aam-text-muted text-xs font-normal">(opsional)</span>
 </label>
 <input
 type="url"
 className={inputClass}
...
export function IzinGuruPage() {
 ...
 <p className="text-sm text-aam-text-muted mt-0.5">Ajukan permohonan izin dan pantau statusnya.</p>
 </div>
 </div>
 ...
 {/* Daftar izin */}
 <div>
 <h3 className="text-sm font-semibold text-aam-text-muted uppercase tracking-wide mb-3">
 Riwayat Pengajuan
 </h3>
 ...
 <p className="text-xs text-aam-text-muted mt-1 italic">
 ...
 <div className="text-xs text-aam-text-muted whitespace-nowrap">
