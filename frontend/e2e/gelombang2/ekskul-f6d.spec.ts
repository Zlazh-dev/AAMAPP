...
test.describe('F6d — Ekstrakurikuler Frontend', () => {
  ...
  test.describe('Kelola Ekskul (Admin)', () => {
    test('Halaman /admin/ekskul dapat diakses', async ({ page }) => {
      await page.goto('/admin/ekskul');
  ...
  test.describe('Kelola Detail Ekskul (Pembina)', () => {
    test('Halaman /admin/ekskul/:id dapat diakses', async ({ page }) => {
      await page.goto('/admin/ekskul/1');
    ...
    test('Tombol Kembali membawa ke /admin/ekskul', async ({ page }) => {
      await page.goto('/admin/ekskul/1');
      await page.locator('#btn-back-ekskul').click();
      await expect(page).toHaveURL('/admin/ekskul');
    });
