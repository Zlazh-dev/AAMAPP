...
/**
 * Gelombang 1 â€” spec (a): form-fokus.
 * Menutup poin QA manual T15-FIX-2: ketik "Budi Santoso" huruf demi huruf
 * di field Nama form siswa â†’ nilai utuh & fokus TIDAK PERNAH lepas dari
...
test('form siswa: ketik nama huruf demi huruf tanpa kehilangan fokus', async ({ page }) => {
  ...
  for (const ch of target) {
    ...
    // Fokus HARUS tetap di input yang sama setelah SETIAP keystroke â€”
