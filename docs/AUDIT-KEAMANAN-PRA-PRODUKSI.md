...
(i) Dependensi: npm audit backend: 0 vulnerabilitas (lockfile missing, npm i --package-lock-only terlebih dahulu); npm audit frontend: 0 vulnerabilitas (lockfile missing, npm i --package-lock-only terlebih dahulu).
